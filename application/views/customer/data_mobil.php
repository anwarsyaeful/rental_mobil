                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-car-wrap">
                            <img style="height:300px" src="<?php echo base_url('assets/upload/'.$mb->gambar) ?>">
                            <div class="car-list-info without-bar">
                                ...
                                <ul class="car-info-list">
                                    <li><?php 
                                        if($mb->ac == "1") {
                                            echo "<i class='fa fa-check-square text-info'></i>";
                                        }else {
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-footer-widget">
                    ...
                    <div class="widget-body">
                        ...
                        <ul class="get-touch">
                            <li><i class="fa fa-map-marker"></i> 14/02, Kalimati, Adiwerna</li>
                            <li><i class="fa fa-mobile"></i> +62 857 0000 1397</li>
                            <li><i class="fa fa-envelope"></i> anwarsyaeful873@gmail.com</li>
                        </ul>
